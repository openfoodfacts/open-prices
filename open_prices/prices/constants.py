...
PRICE_SOURCE_WEB = "WEB"  # Open Prices Web App
PRICE_SOURCE_MOBILE = "MOBILE"  # Smoothie - OpenFoodFacts
PRICE_SOURCE_API = "API"  # API
PRICE_SOURCE_OTHER = "OTHER"  # None, MyMeals
