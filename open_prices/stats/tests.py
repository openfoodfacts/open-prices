...
class TotalStatsTest(TestCase):
    ...
    def test_update_price_stats(self):
        ...
        self.assertEqual(self.total_stats.price_kind_community_count, 0)
        self.assertEqual(self.total_stats.price_kind_consumption_count, 0)
        ...
        self.assertEqual(self.total_stats.price_kind_community_count, 2)
        self.assertEqual(self.total_stats.price_kind_consumption_count, 1)
    ...
    def test_update_proof_stats(self):
        ...
        self.assertEqual(self.total_stats.proof_kind_community_count, 0)
        self.assertEqual(self.total_stats.proof_kind_consumption_count, 0)
        ...
        self.assertEqual(self.total_stats.proof_type_shop_import_count, 0)
        self.assertEqual(self.total_stats.proof_kind_community_count, 1)
        self.assertEqual(self.total_stats.proof_kind_consumption_count, 2)
