...
```
FILEPATH_1=liste_ticket.csv FILEPATH_2=detail_ticket.csv PIVOT_FIELD_NAME=ticket uv run python scripts/gdpr/merge_two_csv_files.py
```
...
```
FILEPATH_1=Carte_Carrefour_NAME_liste_tickets_Tickets.csv FILEPATH_2=Carte_Carrefour_NAME_liste_tickets_Remises.csv PIVOT_FIELD_NAME_LIST="Numéro du ticket de caisse magasin,Code Barre du produit,Description du produit" uv run python scripts/gdpr/merge_two_csv_files.py
```
...
```
FILEPATH_1=Picard_Produits.csv FILEPATH_2=Picard_Tickets.csv PIVOT_FIELD_NAME_LIST="NUMERO DE TICKET" EXCLUDE_FIELD_NAME_LIST="PRIX TTC" uv run python scripts/gdpr/merge_two_csv_files.py
```
